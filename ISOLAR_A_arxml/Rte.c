...
CONST(Rte_SelfType_Algo, RTE_DATA) Rte_Self_CPT_Algo = &Rte_Inst_Algo;
#define RTE_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
...
CONST(Rte_SelfType_BEA, RTE_DATA) Rte_Self_CPT_BEA = &Rte_Inst_BEA;
#define RTE_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
...
CONST(Rte_SelfType_EEA, RTE_DATA) Rte_Self_CPT_EEA = &Rte_Inst_EEA;
#define RTE_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
...
CONST(Rte_SelfType_EcuAbstraction, RTE_DATA) Rte_Self_CPT_EcuAbstraction = &Rte_Inst_EcuAbstraction;
#define RTE_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
...
CONST(Rte_SelfType_SensorSWComponent, RTE_DATA) Rte_Self_CPT_SensorSWComponent = &Rte_Inst_SensorSWComponent;
#define RTE_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
...
Rte_Read_EEA_Throttle_RPort_Throttle(CONSTP2VAR(float64, AUTOMATIC, RTE_APPL_DATA) data) /* 1 */
{
   ...
   /* Optimizer: Removed resource lock for assignment of global to parameter in highest pri task */
   (*(data)) = Throttle;
   rtn = ((VAR(Std_ReturnType, AUTOMATIC))RTE_E_OK);
