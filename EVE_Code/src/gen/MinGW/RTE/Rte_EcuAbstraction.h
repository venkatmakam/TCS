...
#if defined(RTE_RUNNABLEAPI_RE_EcuAbstraction_Receive)
   /* Do nothing for this and all elif clauses below (rte_sws_2751) */
#elif defined(RTE_RUNNABLEAPI_RE_EcuAbstraction_ReceiveThrottle)
#elif defined(RTE_RUNNABLEAPI_RE_EcuAbstraction_Send)
#else
